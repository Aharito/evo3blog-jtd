...
nav_order: 7
permalink: shablon-bloga-integraciya-dizajna
---
...
Теперь настало время оживить сайт и [выводить в шаблонах настоящее содержимое]({% link docs/007_Выводим контент в шаблоне.md %}).
