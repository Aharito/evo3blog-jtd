...
nav_order: 9
permalink: kontrollery-paket-main-anonsy-zapisej-paginaciya
lastmod: 2023-11-23T14:47:31.752Z
---
...
Мне надоело пользоваться кнопкой "Просмотр" в админке, чтобы перейти куда-то, давайте сделаем [навигационное меню на сайте]({% link docs/009_Навигация по сайту.md %}).
